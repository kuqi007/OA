...
public class OaNotifyService extends CrudService<OaNotifyDao, OaNotify> {
	 ...
	 * @return
	 */
	public List<OaNotify> getUnreadList(String userId){
		List<OaNotify> list=dao.getUnreadList(userId);
		return list;
	}
	/**
	 * 获取已读通知
	 ...
	 * @return
	 */
	public List<OaNotify> getReadList(String userId){
		List<OaNotify> list=dao.getReadList(userId);
		return list;
	}
}