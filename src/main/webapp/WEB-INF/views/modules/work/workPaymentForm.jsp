...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/work/payment/edit?item.id=${item.id}">付款申请单${not empty item.id?'查看':'添加'}</a></li>
	</ul><br/>
	<div style="width:186px;height:250px; margin-left: 1100px;position: absolute;">
		...
		<img alt="流程图" src="${ctxUserfiles }/staticImages/4.png">
	</div>
	<form:form id="inputForm" modelAttribute="workPaymentForm" action="${ctx}/work/payment/save" method="post" class="form-horizontal">
