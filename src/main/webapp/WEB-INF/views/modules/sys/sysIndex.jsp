...
#header .brand {
	font-family: 微软雅黑, Helvetica, Georgia, Arial, sans-serif, 黑体;
	font-size: 26px;
	padding-left: 33px;
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<img class="icon" src="${ctxStatic}/index/logo.png" width="50px" height="50px" style="position:absolute;margin-top:-6px" >
					<span id="productName" style="margin-left:60px">${fns:getConfig('productName')}</span>
				</div>
				<ul id="userControl" class="nav pull-right">
					...
					<li id="themeSwitch" class="dropdown"><!-- <a
						...
						<a style="padding:0px" href="${ctx}/sys/user/info" target="mainFrame"><img class="icon" src="${fns:getUser().photo}"  width="50px" height="50px" ></img></a>
						</c:if><!-- </a> -->
						<c:if test="${empty (fns:getUser().photo)}">
						<a  style="padding:0px" href="${ctx}/sys/user/info" target="mainFrame"><img class="icon" src="${ctxStatic}/index/tx.jpg" width="50px" height="50px" ></img></a>
						</c:if>
