...
<head>
	...
	<script type="text/javascript">
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"${checked}",nocheckInherit:true},
				async:{enable:(type==3),url:"${ctx}/sys/user/treeData2",autoParam:["id=officeId"]},
				data:{simpleData:{enable:true}},callback:{<%--
					...
					onClick:function(event, treeId, treeNode){
						if(!treeNode.isParent){
							/**点击子节点时候给父级iframe加载属性 */
							parent.$("#officeContent").attr("src","${ctx}/contact/form?id="+treeNode.id);
						}else{
...
<body>
	...
	<div id="search" class="form-search hide" style="padding:0;">
		<!-- <label for="key" class="control-label" style="padding:0;">关键字：</label> -->
		<input type="text" class="empty" id="key" placeholder="搜索姓名"name="key" maxlength="50" style="width:55%;">
