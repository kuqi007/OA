...
<html>
<head>
<link href="${ctxStatic}/index/indexCalendar/css/wnl.css"
	rel="stylesheet" type="text/css" />
<script>var TIME = {_: +new Date}, newMinotor = 1, So = {
        "comm": {
            "abv": "c",
        ...
        }, "web": {}, "page": {"reload": [], "unload": []}, "onebox": {}, "e": {}
    };</script>
...
<script>(function (e, t, n) {
    ...
    (function (e) {
        ...
        e.OB = i, i.Browser = function () {
            var t = e.navigator, n = t.userAgent.toLowerCase(), r = /(msie|webkit|gecko|presto|opera|safari|firefox|chrome|maxthon|android|ipad|iphone|webos|hpwos)[ \/os]*([\d_.]+)/ig, i = {platform: t.platform};
        ...
        var a = {
            jquery: {
                url: "${ctxStatic}/index/indexCalendar/js/183.js", checker: function () {
                    return !!e.jQuery
                }
            }, "require.2.1.11": {
	...
	<div id="main">
		...
		<ul id="m-result" class="result">
			<li id="first" class="res-list">
				<div id="mohe-rili" class="g-mohe" data-mohe-type="rili">
					...
					<div class="mh-rili-wap mh-rili-only " data-mgd='{"b":"rili-body"}'>
						...
						<div class="mh-rili-widget">
								...
								<div class="mh-cal-main">
									...
									<div class="mh-col-2 mh-almanac">
										...
										<div class="mh-almanac-extra gclearfix" style="display: none;">
											<div class="mh-suited">
												<h2 class="mh-st-label">宜</h2>
												<ul class="mh-st-items gclearfix"></ul>
											</div>
											<div class="mh-tapu">
												<h2 class="mh-st-label">忌</h2>
												<ul class="mh-st-items gclearfix"></ul>
											</div>
										</div>
                             ...
                             */
                             (function () {
                                 window.OB = window.OB || {}, window.OB.RiLi = window.OB.RiLi || {}, window.OB.RiLi.dateRest = ["0101", "0102", "0103", "0207", "0208", "0209", "0210", "0211", "0212", "0213", "0402", "0403", "0404", "0430", "0501", "0502", "0609", "0610", "0611", "0915", "0916", "0917", "0915", "0916", "0917", "1001", "1002", "1003", "1004", "1005", "1006", "1007"], window.OB.RiLi.dateWork = ["0206", "0214", "0612", "0918", "1008", "1009"], window.OB.RiLi.dateFestival = ["20160101||元旦", "20160208||春节", "20160404||清明节", "20160501||劳动节", "20160609||端午节", "20160915||中秋节", "20161001||国庆节"], window.OB.RiLi.dateAllFestival = ["正月初一|v,春节", "正月十五|v,元宵节", "二月初二|v,龙头节", "五月初五|v,端午节", "七月初七|v,七夕节", "七月十五|v,中元节", "八月十五|v,中秋节", "九月初九|v,重阳节", "十月初一|i,寒衣节", "十月十五|i,下元节", "腊月初八|i,腊八节", "腊月廿三|i,祭灶节", "0202|i,世界湿地日,1996", "0214|v,西洋情人节", "0308|i,国际妇女节,1975", "0315|i,国际消费者权益日,1983", "0422|i,世界地球日,1990", "0501|v,国际劳动节,1889", "0512|i,国际护士节,1912", "0518|i,国际博物馆日,1977", "0605|i,世界环境日,1972", "0623|i,国际奥林匹克日,1948", "0624|i,世界骨质疏松日,1997", "1117|i,世界学生日,1942", "1201|i,世界艾滋病日,1988", "0101|v,元旦", "0312|i,植树节,1979", "0504|i,五四青年节,1939", "0601|v,儿童节,1950", "0701|v,建党节,1941", "0801|v,建军节,1933", "0903|v,抗战胜利纪念日", "0910|v,教师节,1985", "1001|v,国庆节,1949", "1224|v,平安夜", "1225|v,圣诞节", "w:0520|v,母亲节,1913", "w:0630|v,父亲节", "w:1144|v,感恩节(美国)", "w:1021|v,感恩节(加拿大)"];
                                 var e = "https://s.ssl.qhimg.com/!97be6a4c/data/";
                                 location.protocol == "https:" && (e = "https://s.ssl.qhimg.com/!97be6a4c/data/"), window.OB.RiLi.hlUrl = {
                                     2008: e + "hl2008.js",
                                     2009: e + "hl2009.js",
                                     2010: e + "hl2010.js",
                                     2011: e + "hl2011.js",
					...
					<select class="mh-holiday-data" style="display: none;">
						...
						<option value="国庆节"
							data-desc="10月1日至7日放假调休，共7天。10月8日（星期六）、10月9日（星期日）上班。" data-gl="">国庆节</option>
						<option value="中秋节" data-desc="9月15日至17日放假调休，共3天。9月18日（星期日）上班。"
							data-gl="">中秋节</option>
						<option value="端午节" data-desc="6月9日至11日放假调休，共3天。6月12日（星期日）上班。"
							data-gl="">端午节</option>
						<option value="劳动节" data-desc="5月1日放假，5月2日（星期一）补休。" data-gl="">劳动节</option>
						<option value="清明节" data-desc="4月4日放假，与周末连休。" data-gl="">清明节</option>
						<option value="春节"
							data-desc="2月7日至13日放假调休，共7天。2月6日（星期六）、2月14日（星期日）上班。" data-gl="">春节</option>
						<option value="元旦" data-desc="1月1日放假，与周末连休。" data-gl="">元旦</option>
					</select>
					<!-- 	 <select class="mh-holiday-data" style="display: none;">
						<option value="0" data-desc="" data-gl="">放假安排</option>
						<option value="抗战胜利纪念日" data-desc="9月3日至5日放假调休，共3天。9月6日（星期日）上班。"
							data-gl="">抗战胜利纪念日</option>
						...
						<option value="春节"
							data-desc="2月18日至24日放假调休，共7天。2月15日（星期日）、2月28日（星期六）上班。" data-gl="">春节</option>
				...
				</div> <script>_loader.use("jquery", function () {
                function l() {
                ...
                _loader.add("rili-widget", "${ctxStatic}/index/indexCalendar/js/wnl.js");//上述JS文件们已让我压缩成wnl.js
