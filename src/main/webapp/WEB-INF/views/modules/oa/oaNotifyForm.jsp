...
<body>
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="oa:oaNotify:edit"><li><a href="${ctx}/oa/oaNotify/">公告列表</a></li></shiro:hasPermission>
		<li class="active"><a href="${ctx}/oa/oaNotify/form?id=${oaNotify.id}">公告<shiro:hasPermission name="oa:oaNotify:edit">${oaNotify.status eq '1' ? '查看' : not empty oaNotify.id ? '修改' : '添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaNotify:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="content" htmlEscape="false" rows="6" maxlength="2000" class="input-xxlarge required" style="resize:none"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
