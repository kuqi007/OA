...
System.out.println("ppp"+ex.getMessage());
// 如果是异步请求或是手机端，则直接返回信息
if (Servlets.isAjaxRequest(request)) {
	out.print(sb);
}else if(ex.getMessage()!=null&&(ex.getMessage()).equals("Transaction rolled back because it has been marked as rollback-only")){
	%>
	...
	<html>
	<head>
		<title>用品数量可能不足 O(∩_∩)O</title>
		<%@include file="/WEB-INF/views/include/head.jsp" %>
	</head>
	<body><br/>
		用品库存可能不足,请刷新页面后再添加!<br/><br/>
		- ( ゜- ゜)つロ 乾杯~<br/><br/>
