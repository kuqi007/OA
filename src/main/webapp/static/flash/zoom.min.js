...
function onchange(level) {
	if (!cookie('zoom') && (level < 1 || level >= 2)) {
		...
		$('.com-zoom-tips-hack').css('font-size', 12 / level + 'px').show(
				"slow");
	} else {
		$('.com-zoom-warn').slideUp("slow");
		$('.com-zoom-tips-hack').hide("slow");
